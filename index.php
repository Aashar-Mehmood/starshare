              ...
              <div class="row">
                      ...
                      <div class="card-spacer mt-n25">
                        ...
                        <div class="row m-0">
                          <div class="col bg-light-warning px-6 py-8 rounded-xl mr-7 mb-7 customCSS">
                            ...
                            <p class="text-warning font-weight-bold font-size-h6">Total Users</p>
                            <br>
                            <h2 class="pt-5">
                              <?php echo $totalUsers ?>
                            </h2>
                          ...
                          <div class="col bg-light-success px-6 py-8 rounded-xl mb-7 customCSS">
                            ...
                            <p class="text-success font-weight-bold font-size-h6 mt-2">Added this year</p>
                            <h2 class="pt-5">
                              <?php echo $yearUsers ?>
                            </h2>
                          </div>
                        ...
                        <div class="row m-0">
                          <div class="col bg-light-danger px-6 py-8 rounded-xl mr-7 customCSS">
                            ...
                            <p class="text-danger font-weight-bold font-size-h6 mt-2">Added this month</p>
                            <h2 class="pt-5">
                              <?php echo $monthUsers ?>
                            </h2>
                          </div>
                          <div class="col bg-light-primary px-6 py-8 rounded-xl customCSS">
                            ...
                            <p class="text-primary font-weight-bold font-size-h6 mt-2">Added today</p>
                            <h2 class="pt-5">
                              <?php echo $todayUsers ?>
                            </h2>
                          </div>
                      ...
                      <div class="card-spacer mt-n25">
                        ...
                        <div class="row m-0">
                          <div class="col bg-light-danger px-6 py-8 rounded-xl mr-7 mb-7">
                            ...
                            <p class="text-danger font-weight-bold font-size-h6">Total Stars</p>
                            <br>
                            <h2 class="pt-5">
                              <?php echo $totalStars ?>
                            </h2>
                          ...
                          <div class="col bg-light-primary px-6 py-8 rounded-xl customCSS mb-7">
                            ...
                            <a href="#" class="text-primary font-weight-bold font-size-h6 mt-2">Added this year</a>
                            <h2 class="pt-5">
                              <?php echo $yearStars ?>
                            </h2>
                          </div>
                        ...
                        <div class="row m-0">
                          <div class="col bg-light-warning px-6 py-8 rounded-xl mr-7 customCSS">
                            ...
                            <p class="text-warning font-weight-bold font-size-h6 mt-2">Added this month</p>
                            <h2 class="pt-5">
                              <?php echo $monthStars ?>
                            </h2>
                          </div>
                          <div class="col bg-light-success px-6 py-8 rounded-xl customCSS">
                            ...
                            <p class="text-success font-weight-bold font-size-h6 mt-2">Added today</p>
                            <h2 class="pt-5">
                              <?php echo $todayStars ?>
                            </h2>
                          </div>
                      ...
                      <div class="card-spacer mt-n25">
                        ...
                        <div class="row m-0">
                          <div class="col bg-light-warning px-6 py-8 rounded-xl mr-7 mb-7 customCSS">
                            ...
                            <p class="text-warning font-weight-bold font-size-h6">Total organizers</p>
                            <br>
                            <h2 class="pt-5">
                          ...
                          <div class="col bg-light-danger px-6 py-8 rounded-xl mb-7">
                            ...
                            <p class="text-danger font-weight-bold font-size-h6 mt-2">Added this year</p>
                            <h2 class="pt-5">
                        ...
                        <div class="row m-0">
                          <div class="col bg-light-primary px-6 py-8 rounded-xl customCSS mr-7">
                            ...
                            <p class="text-primary font-weight-bold font-size-h6 mt-2">Added this month</p>
                            <h2 class="pt-5">
                          ...
                          <div class="col bg-light-success px-6 py-8 rounded-xl customCSS">
                            ...
                            <a href="#" class="text-success font-weight-bold font-size-h6 mt-2">Added today</a>
                            <h2 class="pt-5">
                      ...
                      <div class="card-spacer mt-n25">
                        ...
                        <div class="row m-0">
                          <div class="col bg-light-danger px-6 py-8 rounded-xl mr-7 mb-7">
                            ...
                            <p class="text-danger font-weight-bold font-size-h6">Total Suppliers</p>
                            <br>
                            <h2 class="pt-5">
                          ...
                          <div class="col bg-light-primary px-6 py-8 rounded-xl customCSS mb-7">
                            ...
                            <p class="text-primary font-weight-bold font-size-h6 mt-2">Added this year</p>
                            <h2 class="pt-5">
                ...
                <div class="col-lg-4">
                  ...
                  <div class="card card-custom card-stretch gutter-b">
                    ...
                    <div class="card-header border-0 pt-5">
                      <h3 class="card-title align-items-start flex-column">
                        <span class="card-label font-weight-bolder text-dark"> Songs Activity</span>
                        <span class="text-muted mt-3 font-weight-bold font-size-sm">Latest Songs Uploaded</span>
                      </h3>
                    </div>
                    <!--end::Header-->
                    <!--begin::Body-->
                ...
                <div class="col-lg-4">
                  ...
                  <div class="card card-custom card-stretch gutter-b">
                    ...
                    <div class="card-header border-0 pt-5">
                      <h3 class="card-title align-items-start flex-column">
                        <span class="card-label font-weight-bolder text-dark">Tickets Activity</span>
                        <span class="text-muted mt-3 font-weight-bold font-size-sm">Latest tickets Purchased</span>
                      </h3>
