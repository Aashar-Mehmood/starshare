              ...
              <div class="row">
                      ...
                      <div class="card-spacer mt-n25">
                        ...
                        <div class="row m-0">
                          <div class="col bg-light-warning px-6 py-8 rounded-xl mr-7 mb-7 customCSS">
                            ...
                            <a href="#" class="text-warning font-weight-bold font-size-h6">Total Users</a>
                            <br>
                          ...
                          <div class="col bg-light-success px-6 py-8 rounded-xl mb-7 customCSS">
                            ...
                            <a href="#" class="text-success font-weight-bold font-size-h6 mt-2">Active Users</a>
                            <h2 class="pt-5">800</h2>
                          </div>
                        </div>
                      ...
                      <div class="card-spacer mt-n25">
                        ...
                        <div class="row m-0">
                          <div class="col bg-light-danger px-6 py-8 rounded-xl mr-7 mb-7">
                            ...
                            <a href="#" class="text-danger font-weight-bold font-size-h6">Total Stars</a>
                            <br>
                          ...
                          <div class="col bg-light-primary px-6 py-8 rounded-xl customCSS mb-7">
                            ...
                            <a href="#" class="text-primary font-weight-bold font-size-h6 mt-2">Active Stars</a>
                            <h2 class="pt-5">750</h2>
                          </div>
                        </div>
                        ...
                        <div class="row m-0">
                          ...
                          <div class="col bg-light-success px-6 py-8 rounded-xl customCSS">
                            ...
                            <a href="#" class="text-success font-weight-bold font-size-h6 mt-2">New Stars</a>
                            <h2 class="pt-5">60</h2>
                          </div>
                        </div>
                      ...
                      <div class="card-spacer mt-n25">
                        ...
                        <div class="row m-0">
                          <div class="col bg-light-warning px-6 py-8 rounded-xl mr-7 mb-7 customCSS">
                            ...
                            <a href="#" class="text-warning font-weight-bold font-size-h6">Total organizers</a>
                            <br>
                            <h2 class="pt-5">500</h2>
                          </div>
                          <div class="col bg-light-danger px-6 py-8 rounded-xl mb-7">
                            ...
                            <a href="#" class="text-danger font-weight-bold font-size-h6 mt-2">Active organizers</a>
                            <h2 class="pt-5">400</h2>
                          </div>
                        </div>
                        ...
                        <div class="row m-0">
                          ...
                          <div class="col bg-light-success px-6 py-8 rounded-xl customCSS">
                            ...
                            <a href="#" class="text-success font-weight-bold font-size-h6 mt-2">New organizers</a>
                            <h2 class="pt-5">15</h2>
                          </div>
                        </div>
                      ...
                      <div class="card-spacer mt-n25">
                        ...
                        <div class="row m-0">
                          <div class="col bg-light-danger px-6 py-8 rounded-xl mr-7 mb-7">
                            ...
                            <a href="#" class="text-danger font-weight-bold font-size-h6">Total Suppliers</a>
                            <br>
                            <h2 class="pt-5">1050</h2>
                          </div>
                          <div class="col bg-light-primary px-6 py-8 rounded-xl customCSS mb-7">
                            ...
                            <a href="#" class="text-primary font-weight-bold font-size-h6 mt-2">Active suppliers</a>
                            <h2 class="pt-5">750</h2>
                          </div>
                        </div>
                        ...
                        <div class="row m-0">
                          ...
                          <div class="col bg-light-success px-6 py-8 rounded-xl customCSS">
                            ...
                            <a href="#" class="text-success font-weight-bold font-size-h6 mt-2">New suppliers</a>
                            <h2 class="pt-5">60</h2>
                          </div>
                        </div>
                  ...
                  <div class="card card-custom card-stretch gutter-b">
                    ...
                    <div class="card-header border-0 pt-5">
                      <h3 class="card-title align-items-start flex-column">
                        <span class="card-label font-weight-bolder text-dark">Events Activity</span>
                        <span class="text-muted mt-3 font-weight-bold font-size-sm">Latest Events organized</span>
                      </h3>
                    </div>
                    <!--end::Header-->
                    <!--begin::Body-->
                    <div class="card-body pt-8">
                      ...
                      <div class="d-flex align-items-center mb-10">
                        ...
                        <div class="d-flex flex-column font-weight-bold">
                          <a href="#" class="text-dark text-hover-primary mb-1 font-size-lg">Organizer : Lorem</a>
                          <span class="pt-2">Location: &nbsp;&nbsp; <span class="text-muted">Texas</span></span>
                          <span class="pt-2">Date: &nbsp;&nbsp; <span class="text-muted">12-Oct-2021</span></span>
                        </div>
                        <!--end::Text-->
                      </div>
                      <!--end::Item-->
                ...
                <div class="col-lg-4">
                  ...
                  <div class="card card-custom card-stretch gutter-b">
                    ...
                    <div class="card-header border-0 pt-5">
                      <h3 class="card-title align-items-start flex-column">
                        <span class="card-label font-weight-bolder text-dark">Latest Songs Activity</span>
                        <span class="text-muted mt-3 font-weight-bold font-size-sm">Last 10 Songs bought</span>
                      </h3>
                    </div>
                    <!--end::Header-->
                    <!--begin::Body-->
                    <div class="card-body pt-8">
                      ...
                      <div class="d-flex align-items-center mb-10">
                        ...
                        <!--begin::Text-->
                        <div class="d-flex flex-column font-weight-bold">
                          <a href="#" class="text-dark text-hover-primary mb-1 font-size-lg">Loose Yourself</a>
                          <span>Artist:<span class="text-muted">&nbsp;&nbsp; &nbsp;&nbsp; Eminem</span></span>
                        </div>
                        <!--end::Text-->
                      </div>
                      <!--end::Item-->
                      ...
                      <div class="d-flex align-items-center mb-10">
                        ...
                        <!--begin::Text-->
                        <div class="d-flex flex-column font-weight-bold">
                          <a href="#" class="text-dark-75 text-hover-primary mb-1 font-size-lg">Counting Stars</a>
                          <span>Artist:<span class="text-muted">&nbsp;&nbsp; Eminem</span></span>
                        </div>
                        <!--end::Text-->
                      </div>
                      ...
                      <div class="d-flex align-items-center mb-10">
                        ...
                        <!--begin::Text-->
                        <div class="d-flex flex-column font-weight-bold">
                          <a href="#" class="text-dark text-hover-primary mb-1 font-size-lg">Uptown Funk</a>
                          <span>Artist:<span class="text-muted">&nbsp;&nbsp; Mark Ronson</span></span>
                        </div>
                        <!--end::Text-->
                      </div>
                      <!--end::Item-->
                      ...
                      <div class="d-flex align-items-center mb-10">
                        ...
                        <!--begin::Text-->
                        <div class="d-flex flex-column font-weight-bold">
                          <a href="#" class="text-dark text-hover-primary mb-1 font-size-lg">7 Rings</a>
                          <span>Artist:<span class="text-muted">&nbsp;&nbsp; Mark Ronson</span></span>
                        </div>
                        <!--end::Text-->
                      </div>
                      ...
                      <div class="d-flex align-items-center mb-2">
                        ...
                        <div class="d-flex flex-column font-weight-bold">
                          <a href="#" class="text-dark text-hover-primary mb-1 font-size-lg">7 Rings</a>
                          <span>Artist:<span class="text-muted">&nbsp; &nbsp;Ariana Grande</span></span>
                        </div>
                        <!--end::Text-->
                      </div>
                    </div>
                ...
                <div class="col-lg-4">
                  ...
                  <div class="card card-custom card-stretch gutter-b">
                    ...
                    <div class="card-header border-0 pt-5">
                      <h3 class="card-title align-items-start flex-column">
                        <span class="card-label font-weight-bolder text-dark">Items Sale Purchase Activity</span>
                        <span class="text-muted mt-3 font-weight-bold font-size-sm">Latest Items bought</span>
                      </h3>
