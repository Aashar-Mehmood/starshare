                                        ...
                                        <div class="card-body p-0 position-relative overflow-hidden">
                                            ...
                                            <div class="card-spacer mt-n25">
                                                ...
                                                <div class="row m-0">
                                                    ...
                                                    <div
                                                        class="col bg-light-success px-6 py-8 rounded-xl mb-7 customCSS">
                                                        <span
                                                ...
                                                <div class="row m-0">
                                                    <div
                                                        class="col bg-light-danger px-6 py-8 rounded-xl mr-7 customCSS">
                                        ...
                                        <div class="card-body p-0 position-relative overflow-hidden">
                                            ...
                                            <div class="card-spacer mt-n25">
                                                ...
                                                <div class="row m-0">
                                                    ...
                                                    <div
                                                        class="col bg-light-primary px-6 py-8 rounded-xl customCSS mb-7">
                                                        <span
                                                            class="svg-icon svg-icon-3x svg-icon-primary d-block my-2">
                                                        ...
                                                        <a href="#"
                                                            class="text-primary font-weight-bold font-size-h6 mt-2">Added
                                                            this year</a>
                                                        <h2 class="pt-5">
                                                            <?php echo $yearStars ?>
                                                        </h2>
                                                ...
                                                <div class="row m-0">
                                                    <div
                                                        class="col bg-light-warning px-6 py-8 rounded-xl mr-7 customCSS">
                                                        <span
                                                            class="svg-icon svg-icon-3x svg-icon-warning d-block my-2">
                                    ...
                                    <div class="card card-custom bg-white card-stretch gutter-b">
                                        ...
                                        <div class="card-body p-0 position-relative overflow-hidden">
                                            ...
                                            <div class="card-spacer mt-n25">
                                                ...
                                                <div class="row m-0">
                                                    <div
                                                        class="col bg-light-primary px-6 py-8 rounded-xl customCSS mr-7">
                                                        <span
                                                            class="svg-icon svg-icon-3x svg-icon-primary d-block my-2">
                                                    ...
                                                    <div class="col bg-light-success px-6 py-8 rounded-xl customCSS">
                                                        ...
                                                        <a href="#"
                                                            class="text-success font-weight-bold font-size-h6 mt-2">Added
                                                            today</a>
                                                        <h2 class="pt-5">
                                    ...
                                    <div class="card card-custom card-stretch gutter-b">
                                        ...
                                        <div class="card-body pt-8">
                                            ...
                                            <div class="d-flex align-items-center mb-10">
                                                ...
                                                <div class="d-flex flex-column font-weight-bold">
                                                    <a href="#"
                                                        class="text-dark text-hover-primary mb-1 font-size-lg">Project
                                                        Briefing</a>
                                            ...
                                            <div class="d-flex align-items-center mb-10">
                                                ...
                                                <div class="d-flex flex-column font-weight-bold">
                                                    <a href="#"
                                                        class="text-dark-75 text-hover-primary mb-1 font-size-lg">Concept
                                                        Design</a>
                                            ...
                                            <div class="d-flex align-items-center mb-10">
                                                ...
                                                <div class="d-flex flex-column font-weight-bold">
                                                    <a href="#"
                                                        class="text-dark text-hover-primary mb-1 font-size-lg">Functional
                                                        Logics</a>
