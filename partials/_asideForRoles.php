    ...
    <div id="kt_aside_menu" class="aside-menu" data-menu-vertical="1" data-menu-scroll="1"
      ...
      <ul class="menu-nav">
        ...
        <li class="menu-item menu-item" aria-haspopup="true">
          <a href="pages/login_signup/star/details.php" class="menu-link">
            <span class="svg-icon menu-icon">
        ...
        <li class="menu-item " aria-haspopup="true">
          <a href="pages/login_signup/organizer/details.php" class="menu-link">
            <span class="svg-icon menu-icon">
        ...
        <li class="menu-item " aria-haspopup="true">
          <a href="pages/login_signup/supplier/details.php" class="menu-link">
            <span class="svg-icon menu-icon">
              <!--begin::Svg Icon | path:assets/media/svg/icons/Design/Bucket.svg-->
              <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                height="24px" viewBox="0 0 24 24" version="1.1">
        ...
        <li class="menu-item" aria-haspopup="true">
          <a href="pages/login_signup/logout.php" class="menu-link">
            <span class="svg-icon menu-icon">
