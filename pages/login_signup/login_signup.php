      ...
      <div
        ...
        <div class="d-flex flex-column-fluid flex-center">
          ...
          <div class="login-form login-signin">
            <!--begin::Form-->
            <form class="form fv-plugins-bootstrap fv-plugins-framework" action="pages/login_signup/login_check.php"
              method="POST" id="kt_login_signin_form">
              <!--begin::Title-->
        ...
        <div class="login-form login-signup">
          <!--begin::Form-->
          <form class="form fv-plugins-bootstrap fv-plugins-framework" action="pages/login_signup/signup_check.php"
            method="post" id="kt_login_signup_form">
            <!--begin::Title-->
            <div class="pb-13 pt-lg-0 pt-5">
