                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="card card-custom bg-white card-stretch gutter-b">
                                    ...
                                    <div class="card-header border-0 bg-danger py-5">
                                        <h3 class="card-title font-weight-bolder text-white">Tickets Bought</h3>
                                        <div class="card-toolbar">
                                            <div class="dropdown dropdown-inline">
                                                <a href="#"
                                                    class="btn btn-transparent btn-sm font-weight-bolder px-5"></a>
                                    ...
                                    <div class="card-body p-0 position-relative overflow-hidden">
                                        ...
                                        <div class="card-spacer mt-n25">
                                            ...
                                            <div class="row m-0">
                                                <div
                                                    class="col bg-light-warning px-6 py-8 rounded-xl mr-7 mb-7 customCSS">
                                            ...
                                            <div class="row m-0">
                                                <div class="col bg-light-danger px-6 py-8 rounded-xl mr-7 customCSS">
                                                    ...
                                                    <p class="text-danger font-weight-bold font-size-h6 mt-2">Last Month
                                                    </p>
                                                    <h2 class="pt-5">50</h2>
                                                </div>
                                                <div class="col bg-light-primary px-6 py-8 rounded-xl customCSS">
                                                    ...
                                                    <p class="text-primary font-weight-bold font-size-h6 mt-2">Last Year
                                                    </p>
                                        ...
                                        <div class="card-spacer mt-n25">
                                            ...
                                            <div class="row m-0">
                                                <div class="col bg-light-warning px-6 py-8 rounded-xl mr-7 customCSS">
                                                    ...
                                                    <p class="text-warning font-weight-bold font-size-h6 mt-2">Last
                                                        Month</p>
                                                    <h2 class="pt-5">20</h2>
                                                </div>
                                                <div class="col bg-light-success px-6 py-8 rounded-xl customCSS">
                                                    ...
                                                    <p class="text-success font-weight-bold font-size-h6 mt-2">Last Year
                                                    </p>
                                                    <h2 class="pt-5">26</h2>
                                                </div>
                                            </div>
                    ...
                    <div class="card-spacer mt-n25">
                      ...
                      <div class="row m-0">
                        <div class="col bg-light-primary px-6 py-8 rounded-xl customCSS mr-7">
                          ...
                          <p class="text-primary font-weight-bold font-size-h6 mt-2">Last Month </p>
                          <h2 class="pt-5">14</h2>
                        </div>
                        <div class="col bg-light-success px-6 py-8 rounded-xl customCSS">
                          <span class="svg-icon svg-icon-3x svg-icon-success d-block my-2">
                          ...
                          <p class="text-success font-weight-bold font-size-h6 mt-2">Last Year </p>
                          <h2 class="pt-5">100</h2>
                        </div>
                      </div>
                    ...
                    <div class="card-spacer mt-n25">
                      ...
                      <div class="row m-0">
                        <div class="col bg-light-warning px-6 py-8 rounded-xl mr-7 customCSS">
                          ...
                          <p class="text-warning font-weight-bold font-size-h6 mt-2">Last Month</p>
                          <h2 class="pt-5">5</h2>
                        </div>
                        <div class="col bg-light-success px-6 py-8 rounded-xl customCSS">
                          <span class="svg-icon svg-icon-3x svg-icon-success d-block my-2">
            ...
            if ($_SESSION['is_organizer']) {
                    ...
                    <div class="card-spacer mt-n25">
                      ...
                      <div class="row m-0">
                        <div class="col bg-light-danger px-6 py-8 rounded-xl mr-7 customCSS">
                          ...
                          <p class="text-danger font-weight-bold font-size-h6 mt-2">Last Month</p>
                          <h2 class="pt-5">50</h2>
                        </div>
                        <div class="col bg-light-primary px-6 py-8 rounded-xl customCSS">
                          <span class="svg-icon svg-icon-3x svg-icon-primary d-block my-2">
                          ...
                          <p class="text-primary font-weight-bold font-size-h6 mt-2">Last Year</p>
                          <h2 class="pt-5">100</h2>
                        </div>
                      </div>
              ...
              <div class="col-lg-6">
                <div class="card card-custom bg-white card-stretch gutter-b">
                  <!--begin::Header-->
                  <div class="card-header border-0 bg-warning py-5">
                    <h3 class="card-title font-weight-bolder text-white">Artists Hired</h3>
                    <div class="card-toolbar">
                      <div class="dropdown dropdown-inline">
                        <a href="#" class="btn btn-transparent btn-sm font-weight-bolder px-5"></a>
                        <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
            ...
            if ($_SESSION['is_supplier']) {
              ...
              <div class="col-lg-6">
                ...
                <div class="card card-custom bg-white card-stretch gutter-b">
                  ...
                  <!--begin::Header-->
                  <div class="card-header border-0 bg-success py-5">
                    <h3 class="card-title font-weight-bolder text-white">Products Supplied</h3>
                    <div class="card-toolbar">
                      <div class="dropdown dropdown-inline">
                        <a href="#" class="btn btn-transparent btn-sm font-weight-bolder px-5"></a>
                        <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
