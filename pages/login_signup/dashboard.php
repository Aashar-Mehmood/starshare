                    ...
                    <div class="card-spacer mt-n25">
                      ...
                      <div class="row m-0">
                        <div class="col bg-light-warning px-6 py-8 rounded-xl mr-7 mb-7 customCSS">
                          ...
                          <a href="#" class="text-warning font-weight-bold font-size-h6">Total</a>
                          <br>
                        ...
                        <div class="col bg-light-success px-6 py-8 rounded-xl mb-7 customCSS">
                          ...
                          <a href="#" class="text-success font-weight-bold font-size-h6 mt-2">Today</a>
                          <h2 class="pt-5">6</h2>
                        </div>
                      </div>
                      ...
                      <div class="row m-0">
                        <div class="col bg-light-danger px-6 py-8 rounded-xl mr-7 customCSS">
                          ...
                          <a href="#" class="text-danger font-weight-bold font-size-h6 mt-2">Last Month</a>
                          <h2 class="pt-5">50</h2>
                        </div>
                        <div class="col bg-light-primary px-6 py-8 rounded-xl customCSS">
                          ...
                          <a href="#" class="text-primary font-weight-bold font-size-h6 mt-2">Last Year</a>
                    ...
                    <div class="card-spacer mt-n25">
                      ...
                      <div class="row m-0">
                        <div class="col bg-light-danger px-6 py-8 rounded-xl mr-7 mb-7">
                          ...
                          <a href="#" class="text-danger font-weight-bold font-size-h6">Total</a>
                          <br>
                        ...
                        <div class="col bg-light-primary px-6 py-8 rounded-xl customCSS mb-7">
                          ...
                          <a href="#" class="text-primary font-weight-bold font-size-h6 mt-2">Today</a>
                          <h2 class="pt-5">3</h2>
                        </div>
                      </div>
                      ...
                      <div class="row m-0">
                        <div class="col bg-light-warning px-6 py-8 rounded-xl mr-7 customCSS">
                          ...
                          <a href="#" class="text-warning font-weight-bold font-size-h6 mt-2">Last Month</a>
                          <h2 class="pt-5">20</h2>
                        </div>
                        <div class="col bg-light-success px-6 py-8 rounded-xl customCSS">
                          ...
                          <a href="#" class="text-success font-weight-bold font-size-h6 mt-2">Last Year</a>
                          <h2 class="pt-5">26</h2>
                        </div>
                      </div>
                    ...
                    <div class="card-spacer mt-n25">
                      ...
                      <div class="row m-0">
                        ...
                        <div class="col bg-light-danger px-6 py-8 rounded-xl mb-7">
                          ...
                          <a href="#" class="text-danger font-weight-bold font-size-h6 mt-2">Today </a>
                          <h2 class="pt-5">4</h2>
                        </div>
                      </div>
                      ...
                      <div class="row m-0">
                        <div class="col bg-light-primary px-6 py-8 rounded-xl customCSS mr-7">
                          ...
                          <a href="#" class="text-primary font-weight-bold font-size-h6 mt-2">Last Month </a>
                          <h2 class="pt-5">14</h2>
                        </div>
                        <div class="col bg-light-success px-6 py-8 rounded-xl customCSS">
                          <span class="svg-icon svg-icon-3x svg-icon-success d-block my-2">
