...
$songQuery = "SELECT `id` FROM my_songs WHERE buyer_id = $id";
...
$limitSelect = "SELECT `my_songs`.`id`,`buyer_id`, `title`, `original`, `banner`, `price`, `downloads`
FROM `my_songs` INNER JOIN `songs` ON `my_songs`.`song_id`=`songs`.`id` 
WHERE buyer_id = $id
LIMIT  $songPerPage OFFSET $offset;";
            ...
            <div class="d-flex flex-column flex-row-fluid wrapper" id="kt_wrapper">
                ...
                if (mysqli_num_rows($songData) == 0) {
                  echo  '<div class="row d-flex flex-center">
                            <h2>No Songs in your music library.</h2>
                          </div>';
                } else {
                  echo '<div class="row">';
              ...
              if (mysqli_num_rows($songData) > 0) {
                ...
                echo "<a href='pages/login_signup/library/library.php?page=$prev' class='btn btn-icon btn-sm btn-light-primary mr-2 my-1'><i
                    class='ki ki-bold-arrow-back icon-xs'></i></a>";
                for ($i = 1; $i <= $totalPages; $i++) {
                  echo "<a href='pages/login_signup/library/library.php?page=$i'
                ...
                echo "<a href='pages/login_signup/library/library.php?page=$next' class='btn btn-icon btn-sm btn-light-primary mr-2 my-1'><i
