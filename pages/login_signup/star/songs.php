          ...
          <div class="tab-content mt-5" id="myTabContent" style="overflow-x: hidden;">
            ...
            <div class="tab-pane fade show active" id="kt_tab_pane_2" role="tabpanel" aria-labelledby="kt_tab_pane_2">
              <div class="container">
                ...
                if (mysqli_num_rows($songData) == 0) {
                  ...
                  while ($songArr = mysqli_fetch_assoc($songData)) {
                    ...
                    $buyerId = $_SESSION['id'];
                    // check if song is already bought
                    $mySongsData = mysqli_query($conn, "SELECT `id` FROM `my_songs` WHERE `buyer_id` = $buyerId AND  `song_id` = $sId;");
                    if (mysqli_num_rows($mySongsData) > 0) {
              ...
              if (mysqli_num_rows($songData) > 0) {
                ...
                echo "<a href='pages/login_signup/star/songs.php?starId=$id&page=$prev' class='btn btn-icon btn-sm btn-light-primary mr-2 my-1'><i
                    class='ki ki-bold-arrow-back icon-xs'></i></a>";
                for ($i = 1; $i <= $totalPages; $i++) {
                  echo "<a href='pages/login_signup/star/songs.php?starId=$id&page=$i'
                ...
                echo "<a href='pages/login_signup/star/songs.php?starId=$id&page=$next' class='btn btn-icon btn-sm btn-light-primary mr-2 my-1'><i
