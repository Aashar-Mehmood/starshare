                ...
                <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                    <div class="tab-content mt-5" id="myTabContent" style="overflow-x: hidden;">
                                                ...
                                                <div class="d-flex justify-content-between flex-column pt-4 h-100">
                                                    ...
                                                    <div class="pb-5">
                                                        ...
                                                        <div class="pt-1">
                                                            <!--begin::Text-->
                                                            <p
                                                                class="text-dark-75 font-weight-normal font-size-lg m-0 pb-7">
                        ...
                        <div class="tab-pane fade " id="kt_tab_pane_2" role="tabpanel" aria-labelledby="kt_tab_pane_2">
                            <div class="modal fade" id="newSong" tabindex="-1" role="dialog"
                                ...
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form class="form" action="pages/login_signup/star/addSong.php"
                                    ...
                                    <div class="col-xl-10">
                                        <div class="card card-custom gutter-b">
                                            ...
                                            <div class="card-header d-flex align-items-center">
                                                ...
                                                <button class="btn btn-primary btn-large" data-target="#newSong"
                                                    data-toggle="modal">
                                                    Add Song
                                                </button>
                                            </div>
                        ...
                        <div class="tab-pane fade" id="kt_tab_pane_3" role="tabpanel" aria-labelledby="kt_tab_pane_3">
                            <div class="container">
                                <h2 class="text-dark pl-md-8">Events Performed</h2>
                                <div class="row">
                                    <div class="col-md-6 col-xl-4">
                                        <div class="card card-custom bg-gray-100 card-stretch gutter-b">
                                                            ...
                                                            <div class="d-flex flex-center pb-9">
                                                                ...
                                                                <div class="d-flex flex-column flex-grow-1">
                                                                    <a href="#"
                                                                        ...
                                                                        Scheduled On : 12-Oct-2022 <br />10PM
                                                                    </a>
                                                                </div>
                                                                <!--end::Text-->
                                                                <!--begin::label-->
                        ...
                        <div class="tab-pane fade" id="kt_tab_pane_4" role="tabpanel" aria-labelledby="kt_tab_pane_5">
                            ...
                            mb-6 mr-10 mb-md-0">Reset</button>
                                                    ...
                                                    <div class="btn-group ml-2">
                                                        <button id="editSettings" name="editSettings" type="button"
                              ...
                              ml-14 ml-md-0 mb-6 mb-md-0">
                                            ...
                                            <div class="card-body">
                                                <form class="form" id="kt_form"
                                                    action="pages/login_signup/updateRoleSettings/update.php?role=star"
                                                    method="POST" enctype="multipart/form-data">
                                                                    ...
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <div class="col-md-9">
                                                                            <div class="image-input image-input-empty image-input-outline"
                                                                                ...
                                                                                style="background-image: url(<?php echo $profile ?>)">
                                                                    ...
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <div class="col-md-9">
                                                                            <input name="fullName"
                                                                                ...
                                                                                type="text"
                                                                                placeholder="<?php echo $_SESSION['star_name'] ?>">
                                                                        </div>
                                                                    </div>
                                                                    <!--end::Group-->
                                                                    <!--begin::Group-->
