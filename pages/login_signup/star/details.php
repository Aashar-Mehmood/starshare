        ...
        <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
          <div class="tab-content mt-5" id="myTabContent" style="overflow-x: hidden;">
            ...
            <div class="tab-pane fade" id="kt_tab_pane_2" role="tabpanel" aria-labelledby="kt_tab_pane_2">
              <div class="modal fade" id="newSong" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
                aria-hidden="true">
                    ...
                    <div class="modal-body">
                      <form class="form">
                        ...
                        <div class="form-group">
                          ...
                          <div class="custom-file">
                            <input type="file" class="custom-file-input" id="customFile" />
                            <label class="custom-file-label" for="customFile">Choose Sample</label>
                          </div>
                        </div>
                        <div class="form-group">
                            ...
                            <table class="table table-vertical-center table-bordered">
                              <thead class="thead-dark">
                                <tr>
                                  ...
                                  <th style="min-width: 150px;">Artist Name</th>
                                  <th style="min-width: 150px;">Duration (minutes)</th>
                              ...
                              <tbody>
                                <tr>
                                  ...
                                  <td>
                                    <a href="javascript:void(0)" title="Edit" data-target="#newSong" data-toggle="modal"
                              ...
                              <div class="row">
                                <div class="col-xl-7 my-2">
                                  ...
                                  <div class="row">
                                    ...
                                    <div class="col-md-9">
                                      <h6 class="text-dark font-weight-bold mb-10">Star Info:</h6>
                                    </div>
                                  </div>
                                  <!--end::Row-->
                                  <!--begin::Group-->
