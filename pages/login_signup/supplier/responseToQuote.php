                        ...
                        <div class="row flex flex-center">
                            <div class="col-md-6 pr">
                                ...
                                <div class="card card-rounded">
                                    ...
                                    <div class="card-body">
                                        <form class="form" action="pages/login_signup/supplier/processResponse.php" method="POST">
                                            <input type="hidden" name="quoteId" value="<?php echo $quoteId ?>">
                                            <div class="form-group">
                                                <label>Quote Amount :</label>
                                                <input type="text" name="supplierQuoteAmount" value="<?php echo htmlspecialchars($_SESSION['form_data']['supplierQuoteAmount'] ?? '', ENT_QUOTES); ?>" class="form-control form-control-solid" />
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea rows="6" name="supplierQuote" class="form-control form-control-solid"><?php echo htmlspecialchars($_SESSION['form_data']['supplierQuote'] ?? '', ENT_QUOTES); ?></textarea>
                                            </div>

                                            <div class="d-flex w-md-50 justify-content-between mt-12">
                                                <input type="submit" name="responded" value="Respond" class="btn btn-primary">
                                                <a href="pages/login_signup/supplier/details.php?parentId=supplier&activeTab=3">
