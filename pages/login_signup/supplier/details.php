                          ...
                          <table class="table table-vertical-center table-bordered">
                            ...
                            <tbody>
                              <tr>
                                ...
                                <td>
                                  <a href="javascript:void(0)" title="Edit" data-target="#newProduct"
                    ...
                    <div class="card card-custom">
                      ...
                      <div class="card-body">
                        <form class="form" id="kt_form"
                          action="pages/login_signup/updateRoleSettings/update.php?role=supplier" method="POST"
                              ...
                              <div class="row">
                                <div class="col-xl-7 my-2">
                                  ...
                                  <div class="row">
                                    ...
                                    <div class="col-md-9">
                                      <h6 class="text-dark font-weight-bold mb-10">Supplier Info:</h6>
                                    </div>
                                  </div>
                                  <!--end::Row-->
                                  <!--begin::Group-->
