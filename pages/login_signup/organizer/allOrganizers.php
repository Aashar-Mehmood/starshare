...
$countQuery = "SELECT * FROM `organizers`;";


if (isset($_POST['search']) && !empty($_POST['searchedText'])) {
  $searchedText = $_POST['searchedText'];
  $countQuery = "SELECT * FROM `organizers` WHERE `name` LIKE '%$searchedText%' OR `address` LIKE '%$searchedText%' ;";
}
...
$limitSelect = "SELECT * FROM `organizers` LIMIT $recordPerPage OFFSET $offset;";

if (isset($_POST['search']) && !empty($_POST['searchedText'])) {
  $searchedText = $_POST['searchedText'];
  $limitSelect = "SELECT * FROM `organizers` WHERE `name` LIKE '%$searchedText%' OR `address` LIKE '%$searchedText%' LIMIT $recordPerPage OFFSET $offset;";
}
...
<head>
  <base href="../../../">
  <meta charset="utf-8" />
  <title>Organizer Public Profile</title>
          ...
          <div class="container">
            ...
            <div class="row">
              ...
              while ($record = mysqli_fetch_assoc($limitResult)) {
                ...
                $countEvents = mysqli_query($conn, "SELECT * FROM `events` WHERE `organizer_id` = $id;");
                ...
                <div class="card card-custom gutter-b">
                  ...
                  '</span>
                        ...
                        <div class="pt-1">
                          ...
                          <div class="d-flex align-items-center justify-content-between pb-7">
                            ...
                            <!--end::Symbol-->
                            <p class="text-dark font-size-lg">Total Events</p>
                            <!--begin::label-->
                            <span
                  ...
                  "<a href='pages/login_signup/organizer/upcomingEvents.php?organizerId=$id'>" .
            ...
            <div class="d-flex justify-content-center align-items-center flex-wrap mt-12">
              <div class="d-flex flex-wrap py-2 px-6 justify-content-center" style="background-color: white; border-radius: 10px; width:60%;">
                ...
                echo "<a href='pages/login_signup/organizer/allOrganizers.php?page=$prev' class='btn btn-icon btn-sm btn-light-primary mr-2 my-1'><i
                class='ki ki-bold-arrow-back icon-xs'></i></a>";
                for ($i = 1; $i <= $totalPages; $i++) {
                  echo "<a href='pages/login_signup/organizer/allOrganizers.php?page=$i' id = 'page$i'
                ...
                echo "<a href='pages/login_signup/organizer/allOrganizers.php?page=$next' class='btn btn-icon btn-sm btn-light-primary mr-2 my-1'><i
