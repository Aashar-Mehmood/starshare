                    ...
                    <div class="d-flex justify-content-between flex-column pt-4 h-100">
                      ...
                      <div class="pb-5">
                        ...
                        <div class="d-flex flex-column flex-center">
                          ...
                          <!--begin::Username-->
                          <a href="#"
                            class="card-title font-weight-bolder text-dark-75 text-hover-primary font-size-h4 m-0 pt-7 pb-1">John
                            Doe</a>
                          <!--end::Username-->
                          <!--begin::Info-->
                          <div class="font-weight-bold text-dark-50 font-size-sm pb-6">Organizer related info</div>
                          <!--end::Info-->
                        </div>
                        <!--end::Header-->
                        <!--begin::Body-->
                        <div class="pt-1">
                          ...
                          <div class="d-flex justify-content-center">
                            <a href="pages/login_signup/organizer/upcomingEvents.php">
