...
<body id="kt_body" class="header-fixed header-mobile-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
        ...
        <div class="content d-flex flex-column flex-column-fluid px-8 py-12" id="kt_content">
          ...
          <div class="container">
            <div class="row flex flex-center my-8">
              <div class="col-lg-12">
                <form action="pages/stars/stars.php?activeLinkId=stars" method="POST">
                  ...
                  <a href="pages/stars/stars.php?activeLinkId=stars" class="btn btn-primary btn-lg ml-8">
                    Reset Filter
                  </a>
                </form>
                          ...
                          <tbody>
                            ...
                            while ($record = mysqli_fetch_assoc($limitResult)) {
                              ...
                              <td class="pr-0 justify-content-between">
                                ' . "<a href='pages/stars/star_details.php?starId=$sId&activeLinkId=stars'
            ...
            <div class="d-flex justify-content-center align-items-center flex-wrap mt-12">
              <div class="d-flex flex-wrap py-2 px-6 justify-content-center" style="background-color: white; border-radius: 10px; width:60%;">
                ...
                echo "<a href='pages/stars/stars.php?page=$prev&activeLinkId=stars' class='btn btn-icon btn-sm btn-light-primary mr-2 my-1'><i
                class='ki ki-bold-arrow-back icon-xs'></i></a>";
                for ($i = 1; $i <= $totalPages; $i++) {
                  echo "<a href='pages/stars/stars.php?page=$i&activeLinkId=stars' id = 'page$i'
                ...
                echo "<a href='pages/stars/stars.php?page=$next&activeLinkId=stars' class='btn btn-icon btn-sm btn-light-primary mr-2 my-1'><i
  ...
  ?>
  <script>
    // params is defined in _aside.php
    var activePagination = '';
    if (params.has('page')) {
      activePagination = `page${params.get('page')}`
    } else {
      activePagination = "page1";
    }
    var activePage = document.getElementById(`${activePagination}`);
