...
if(!isset($_GET['starId'])){
  ...
  function addDay($period){
    $next = date_add(new DateTime('now'), new DateInterval($period));
  ...
  $upComingEvents = "SELECT * FROM `events` WHERE `star_id` = $id AND (`date`= '$nextDay1' OR `date`= '$nextDay2' OR`date`= '$nextDay3');";
        ...
        <div id="kt_header" class="header header-fixed">
          ...
          <div class="container-fluid d-flex align-items-stretch justify-content-between">
            ...
            <ul class="nav nav-tabs nav-tabs-line nav-bold nav-tabs-line-2x d-flex align-items-center ml-2 ml-md-8"
              ...
              <li class="nav-item">
                <a class="nav-link active" href="pages/stars/eventsPerformed.php?starId=<?php echo $id ?>">Events Performed</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="pages/stars/transactions.php?starId=<?php echo $id ?>">Transactions</a>
              </li>
            </ul>
            <!--end::Header Menu-->
                ...
                <div class="row">
                  ...
                  if (mysqli_num_rows($eventData) == 0) {
                    ...
                    while ($eventArr = mysqli_fetch_assoc($eventData)) {
                      echo '<h2 class="text-dark pl-md-8 mt-16">Upcoming Events</h2>
                      <div class="col-md-6 col-xl-4">
