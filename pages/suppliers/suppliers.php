...
if (isset($_POST['search']) && !empty($_POST['searchedCountry'])) {
  ...
  $countQuery = "SELECT * FROM `suppliers` WHERE `address` LIKE '%$country';";
}
...
if (isset($_POST['search']) && !empty($_POST['searchedCountry'])) {
  $country = $_POST['searchedCountry'];
  $limitSelect = "SELECT * FROM `suppliers` WHERE `address` LIKE '%$country' LIMIT $recordPerPage OFFSET $offset;";
}
          ...
          <div class="container">
                          ...
                          <tbody>
                            ...
                            while ($record = mysqli_fetch_assoc($limitResult)) {
                              ...
                              <td class="pr-0 justify-content-between">
                                ...
                                ' . "<a href='pages/suppliers/deletesupplier.php?supplierId=$id' 
            ...
            <div class="d-flex justify-content-center align-items-center flex-wrap mt-12">
              <div class="d-flex flex-wrap py-2 px-6 justify-content-center"
                ...
                echo "<a href='pages/suppliers/suppliers.php?page=$prev' class='btn btn-icon btn-sm btn-light-primary mr-2 my-1'><i
                class='ki ki-bold-arrow-back icon-xs'></i></a>";
                for ($i = 1; $i <= $totalPages; $i++) {
                  echo "<a href='pages/suppliers/suppliers.php?page=$i' id = 'page$i'
                ...
                echo "<a href='pages/suppliers/suppliers.php?page=$next' class='btn btn-icon btn-sm btn-light-primary mr-2 my-1'><i
