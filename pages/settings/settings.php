                ...
                <div class="card-header card-header-tabs-line nav-tabs-line-3x">
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="btn-group ml-2">
                      <button type="button" class="btn btn-primary font-weight-bold btn-sm px-3 font-size-base">Save
                        Changes</button>
                      <button type="button"
                        ...
                        <div class="row">
                          ...
                          <div class="col-xl-8">
                            <div class="my-2">
                              ...
                              <div class="form-group row">
                                <label class="col-form-label col-3 text-lg-right text-left">Send Copy To Personal
                                  Email</label>
                                <div class="col-3">
                                  <span class="switch">
                                    <label>
