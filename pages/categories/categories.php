                      ...
                      <table class="table table-vertical-center table-bordered" style="table-layout:fixed;">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td class="">
                              <a href="#"
                                class="text-dark-75 font-weight-bolder text-hover-primary mb-1 font-size-lg">Public
                                Organizer</a>

                            </td>
                            <td>
                              <span class="text-dark-75 font-weight-bolder d-block font-size-lg">Event Organizer</span>
                            </td>
                          ...
                          <tr>
                            <td class="">
                              <a href="#"
                                class="text-dark-75 font-weight-bolder text-hover-primary mb-1 font-size-lg">Private
                                Organizer</a>
                            </td>
                            <td>
                              <span class="text-dark-75 font-weight-bolder d-block font-size-lg">Event Organizer</span>
                          ...
                          <tr>
                            ...
                            <td class="">
                              <a href="#"
                                class="text-dark-75 font-weight-bolder text-hover-primary mb-1 font-size-lg">Sub1</a>

                            </td>
                            <td>
                              <span class="text-dark-75 font-weight-bolder d-block font-size-lg">Supplier</span>
                            </td>
                          ...
                          <tr>
                            ...
                            <td class="">
                              <a href="#"
                                class="text-dark-75 font-weight-bolder text-hover-primary mb-1 font-size-lg">Sub2</a>
                            </td>
                            <td>
                              <span class="text-dark-75 font-weight-bolder d-block font-size-lg">Supplier</span>
                            </td>
                          ...
                          <tr>
                            ...
                            <td class="">
                              <a href="#"
                                class="text-dark-75 font-weight-bolder text-hover-primary mb-1 font-size-lg">Sub3</a>
