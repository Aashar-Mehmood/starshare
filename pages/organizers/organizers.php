        ...
        <div class="content d-flex flex-column flex-column-fluid px-8 py-12" id="kt_content">
          ...
          <div class="container">
            <div class="row flex flex-center my-8">
              <div class="col-lg-12">
                <form action="pages/organizers/organizers.php?activeLinkId=organizers" method="POST">
                  ...
                  <a href="pages/organizers/organizers.php?activeLinkId=organizers" class="btn btn-primary btn-lg ml-8">
                    Reset Filter
                  </a>
                </form>
                          ...
                          <tbody>
                            ...
                            while ($record = mysqli_fetch_assoc($limitResult)) {
                              ...
                              <td class="pr-0 justify-content-between">
                                ' . "<a href='pages/organizers/organizer_details.php?activeLinkId=organizers&organizerId=$id'
