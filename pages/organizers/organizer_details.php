            ...
            <div class="tab-content" id="myTabContent">
              <div class="tab-pane fade show active" id="kt_tab_pane_1" role="tabpanel" aria-labelledby="kt_tab_pane_1">
                <div class="container mt-16">
                  ...
                  <div class="row text-dark mt-8 mx-0" style="height:6rem;">
                    ...
                    <div class="col-7 rounded-right pl-6 d-flex flex-column justify-content-center"
                      ...
                      <h2>Events Organized in last Month: 10</h2>
                    </div>
                  </div>
                  <div class="row text-dark mt-8 mx-0" style="height:6rem;">
                    ...
                    <div class="col-7 rounded-right pl-6 d-flex flex-column justify-content-center"
                      ...
                      <h2>Events Organized in last year : 140</h2>
                    </div>
                  </div>
                </div>
                <div class="container mt-16">
                  <h1 class="text-dark">Earnings</h1>
                  <div class="row text-dark mt-8 mx-0" style="height:6rem;">
                    <div class="col-2 pl-6 rounded-left d-flex align-items-center" style="background-color: #67aeca;">
                      <h2>Last Month</h2>
                    </div>
                    <div class="col-7 rounded-right pl-6 d-flex flex-column justify-content-center"
                      style="background-color: #67aecabf;">
                      <h2>Earnings in last month : 700$</h2>
                    </div>
                  </div>
                  <div class="row text-dark  mt-8 mx-0" style="height:6rem;">
                    <div class="col-2 pl-6 rounded-left d-flex align-items-center" style="background-color: #ecd444;">
                      <h2>Last Year</h2>
                    </div>
                    <div class="col-7 rounded-right pl-6 d-flex flex-column justify-content-center"
                      style="background-color:#ecd444bf">
                      <h2>Total earnings in last year : 5000$</h2>
                    </div>
                  </div>
                  <div class="row text-dark mt-8 mx-0" style="height:6rem;">
                    <div class="col-2 pl-6 rounded-left d-flex align-items-center" style="background-color: #e52a6f;">
                      <h2>Total</h2>
                    </div>
                    <div class="col-7 rounded-right pl-6 d-flex flex-column justify-content-center"
                      style="background-color:#e52a6fbf">
                      <h2>Total Earnings : 20000$</h2>
                    </div>
                  </div>
                </div>
              </div>
              <div class="tab-pane fade" id="kt_tab_pane_2" role="tabpanel" aria-labelledby="kt_tab_pane_2">
                          ...
                          <div class="d-flex justify-content-between flex-column h-100">
                            ...
                            <div class="h-100">
                              ...
                              <div class="pt-1">
                                ...
                                <div class="d-flex align-items-center pb-9">
                                  ...
                                  <div class="d-flex flex-column flex-grow-1">
                                    <a href="#"
                                      class="text-dark-75 text-hover-primary mb-1 font-size-lg font-weight-bolder">Available
                                      Seats</a>
                                    <span class="text-muted font-weight-bold">Successful Fellas</span>
                                  </div>
                                  <!--end::Text-->
                            ...
                            <div class="d-flex flex-center" id="kt_sticky_toolbar_chat_toggler_3" data-toggle="tooltip"
                              ...
                              <button class="btn btn-primary font-weight-bolder font-size-sm py-3 px-14"
                                data-toggle="modal" data-target="#kt_chat_modal">Get Ticket</button>
                            </div>
                            <!--end::Footer-->
                          </div>
                          <!--end::Wrapper-->
                ...
                <div class="container mt-12">
                  <h1 class="text-dark">Recent Events</h1>
                  <div class="row mt-12">
                    <div class="col-4">
                      <div class="card card-custom gutter-b">
                        <!--begin::Body-->
